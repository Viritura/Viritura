import type { Sf2Synth } from "@viritura/audio";
...
// The real samplers and PlaybackEngine drive this device; no audio worklet or
// sample rendering runs. Keep the recording port local rather than deep-importing
// the playback package's private test fixture.
