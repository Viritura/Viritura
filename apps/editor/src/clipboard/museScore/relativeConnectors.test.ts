...
function selection(parsed: ReturnType<typeof readMuseScoreClipboard>): ClipboardSelection {
  return { ...parsed, events: parsed.content, timeSignature: { count: 4, unit: 4 }, keySignature: { fifths: 0 } };
}
...
describe("relative Tie import and public export", () => {
  ...
  it("retains unsupported percussion and slur export rejection", () => {
    ...
    delete first.slurs;
    first.kitNotes = [{ component: "snare" }];
