...
import { beatsBetweenMeasures, resolvePhysicalStaffDestination } from "./annotations";
...
export function computeRepeatResult(
  ...
  return { newScore, ...findPlacedSelection(newScore, placedContent, measureIndex, startBeat) };
}
