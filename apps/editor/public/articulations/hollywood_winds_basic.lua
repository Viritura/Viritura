...
--
-- Winds have no pizzicato, and con sordini is a no-op here (same CC, no audible effect), so this
-- mapper uses just three channels:
--
--   Channel 0  Marcato    (short notes, held <= 0.75 s)
--   Channel 1  Sustain    (long notes,  held  > 0.75 s)
--   Channel 2  Staccato
--
