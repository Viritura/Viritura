...
- publishing others' private information without explicit permission; and
...
[support@viritura.com](mailto:support@viritura.com). Do not use a public issue.
Reports will be reviewed promptly and fairly by the project maintainers, who
will respect the reporter's privacy and safety.

## Enforcement guidelines

Community leaders will follow these guidelines when determining consequences:

1. **Correction**: A private, written warning that explains the violation and
   requests an apology or correction.
2. **Warning**: A warning with consequences for continued behavior and a
   temporary restriction on interaction with those involved.
3. **Temporary ban**: A temporary ban from interaction or public communication
   with the community.
4. **Permanent ban**: Permanent removal from community interaction for a pattern
   of violations or serious harassment or aggression.
