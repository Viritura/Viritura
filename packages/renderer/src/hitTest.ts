 ...
 *
 * SpatialIndex stores flat bounding-box entries sorted by x.
 */
...
// Selection overlay helpers have moved to selectionOverlay.ts and hitboxDebug.ts.
// Re-exported here so existing imports
// from @viritura/renderer continue to resolve.
export { paintSelectionOverlay, paintMeasureSelectionOverlay } from "./selectionOverlay";
export { paintHitboxDebug, paintHitboxDebugLegend } from "./hitboxDebug";
