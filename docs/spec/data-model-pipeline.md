...
| [`articulation.rs`](../../engine/viritura-engine/src/promote/articulation.rs)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | Markings + fermata + placement. Hoists `_x.viritura.{staccatissimoWedge, trill, ornaments, arpeggio, fingerings}`. Caesura is native MNX (schema v36+), read from `raw::EventMarkings.caesura` directly. |
| [`direction.rs`](../../engine/viritura-engine/src/promote/direction.rs)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | MNX-core directions: segno/fine/jump/tempo/dynamic/ottava/placement. Tempo hoists `_x.viritura.{text, showMetronomeMark, showText}`.                                                                     |
...
1. **Trivial aliases (decoded == wire)** — _landed (May 2026)_:
   ...
   and `Placement` (carries a `force_stem_up` method that Rust
...
| ------------- | ----: | ----------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- |
| **IDENTICAL** |    20 | Same fields/variants, same serde shape                                        | 18 done (incl. `BarlineType`, `ClefSign`, 7 vendor leaves); 2 deferred (`IdPair`, `Placement`) |
