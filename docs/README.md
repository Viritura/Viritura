...
| [music-notationref-coverage](spec/music-notationref-coverage.md)                      | Source-validated coverage for every W3C Music Notation Reference row across MNX and MusicXML/MXL                                                                    |
...
| [denigma-musx-vendor-gap-architecture](plans/denigma-musx-vendor-gap-architecture.md) | Proposed Denigma/NotationRef conversion-gap catalog, source evidence, and vendor-shim ownership model                                                               |
